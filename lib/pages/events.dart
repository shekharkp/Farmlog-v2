...
import 'package:farmalog/forms/createEvent.dart';
...
class _EventsState extends State<Events> {
  ...
  Future<String> getUserRole() async {
    var userID = await securedstorage.getuserID();
    User user = await firestore_helper.getUserByID(userID);
    return user.role;
  }
          ...
          child: FloatingActionButton(
            ...
            onPressed: () async{
              if(await getUserRole() == "Event Organiser")
                {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => CreateEventForm(),));
                }
              else
                {
                  showMessage("You Don't have permission as your role is Blogger.");
                }
